    ...
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: '#0A0908', minHeight: '100vh', color: '#F5F0E8', display: 'flex' }}>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .res-sidebar.collapsed { width: 68px; min-width: 68px; }
        ...
        .res-sidebar.collapsed .sidebar-logo { opacity: 0; width: 0; }
      ...
      {/* ── SIDEBAR ── */}
      <div className={`res-sidebar ${sidebarCollapsed ? 'collapsed' : ''}`}>
